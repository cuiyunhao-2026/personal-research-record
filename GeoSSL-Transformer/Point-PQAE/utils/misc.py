...
def get_ptcloud_img(ptcloud,roll=0,pitch=0,yaw=0):
    ...
    # gray_color = np.linspace(0.4, 0.9, len(ptcloud))  # 生成灰度值
    # ax.scatter(x, y, z, zdir='z', c=gray_color, cmap='gray')  # 设置灰色点云
    # , s=80
    ax.scatter(x, y, z, zdir='z', c=y, cmap='jet')
    # ax.scatter(x, y, z, zdir='z', c=y, cmap='inferno')  # 使用plasma配色方案
