...
def transform_train(resize_size=256, crop_size=224):
    ...
    return transforms.Compose([
        ...
        transforms.RandomResizedCrop(crop_size, scale=(0.64, 1.0), interpolation=Image.BICUBIC), 
        RandAugmentMC(n=2, m=10),
        transforms.ToTensor(),
        normalize
    ])
    # FIXME torchvision版本可能过低，报错：AttributeError: module 'torchvision.transforms' has no attribute 'InterpolationMode' 
