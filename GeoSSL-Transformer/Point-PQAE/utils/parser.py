...
def get_args():
    ...
    parser.add_argument(
        ...
        default='none',
        help='job launcher')
    parser.add_argument('--model-prefix', type=str, default=None, help='ours: MAE_encoder, Point-MAE: MAE_encoder, PointGPT: GPT_transforer')
    
    parser.add_argument('--vis', default=False, action='store_true')
    parser.add_argument('--rate', type=float, default=1.0)      # 默认不减小数据集大小
    parser.add_argument('--local_rank', type=int, default=0)
    parser.add_argument('--num_workers', type=int, default=8)
    
    parser.add_argument('--whole', type=int, default=1, help='0 means not whole') # default = 1
    # seed 
