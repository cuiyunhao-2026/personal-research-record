...
def build_opti_sche(base_model, config):
    ...
    for name, param in base_model.module.named_parameters():
        ...
        if 'cls' in name and config.model.NAME == 'PointTransformer':       # When adding modules if it is not intended to cls then the name should not contain "cls" to prevent bugs
            print("10 * LR: ", name)       
